...
//    }
    ...
    void addRelationByNames() {
        ...
        gKnowledgeService.addTag(new Knowledge("maven","maven 翻译为\\'专家\\'、\\'内行\\'，是 Apache 下的一个纯 Java 开发的开源项目。基于项目对象模型（缩写：POM）概念，Maven利用一个中央信息片断能管理一个项目的构建、报告和文档等步骤。"));
        ...
        gKnowledgeService.addTag(new Knowledge("算法设计","算法（Algorithm）是指解题方案的准确而完整的描述，是一系列解决问题的清晰指令，算法代表着用系统的方法描述解决问题的策略机制。"));
        ...
        gKnowledgeService.addTag(new Knowledge("C language","C 语言是一种通用的、面向过程式的计算机程序设计语言。1972 年，为了移植与开发 UNIX 操作系统，丹尼斯·里奇在贝尔电话实验室设计开发了 C 语言。"));
        gKnowledgeService.addTag(new Knowledge("Python","Python 是一种解释型、面向对象、动态数据类型的高级程序设计语言。"));
        gKnowledgeService.addTag(new Knowledge("递归算法","程序调用自身的编程技巧称为递归（ recursion）。"));
        ...
        gKnowledgeService.addTag(new Knowledge("数据结构-图","在数学中，图是描述于一组对象的结构，其中某些对象对在某种意义上是“相关的”。"));
        ...
        gKnowledgeService.addTag(new Knowledge("数据结构-堆","堆(Heap)是计算机科学中一类特殊的数据结构，是最高效的优先级队列。堆通常是一个可以被看做一棵完全二叉树的数组对象。"));
        ...
        gKnowledgeService.addRelationByNames("C language","C++","Common");
        gKnowledgeService.addRelationByNames("高级语言","C","include");
        gKnowledgeService.addRelationByNames("高级语言","Java","include");
        gKnowledgeService.addRelationByNames("高级语言","Python","include");
        gKnowledgeService.addRelationByNames("算法设计","高级语言","associated");
        gKnowledgeService.addRelationByNames("算法设计","递归算法","include");
        gKnowledgeService.addRelationByNames("算法设计","最先割技术","include");
        gKnowledgeService.addRelationByNames("算法设计","算法复杂度","preKnowledge");
        gKnowledgeService.addRelationByNames("算法设计","数据结构","preKnowledge");
        gKnowledgeService.addRelationByNames("算法设计","离散数学","preKnowledge");
        ...
        gKnowledgeService.addRelationByNames("递归算法","归纳法","include");
        gKnowledgeService.addRelationByNames("递归算法","动态规划","include");
        gKnowledgeService.addRelationByNames("递归算法","分治法","include");
